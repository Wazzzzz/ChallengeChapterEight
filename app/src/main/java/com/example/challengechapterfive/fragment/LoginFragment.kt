...
import com.example.challengechapterfive.mvvm.LogedViewModel
import com.example.challengechapterfive.repository.viewModelsFactory
...
class LoginFragment : Fragment() {
    ...
    private val logedModel: LogedViewModel by viewModelsFactory { LogedViewModel(pref) }
    private val pref: LogedDataStoreManager by lazy { LogedDataStoreManager(requireContext()) }
